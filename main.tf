...
locals {
  ...
  # Unfortunately, most_recent (https://github.com/assignment/terraform-aws-eks-workers/blob/34a43c25624a6efb3ba5d2770a601d7cb3c0d391/main.tf#L141)
...
module "subnets" {
  source  = "assignment/dynamic-subnets/aws"
  version = "0.28.0"
...
module "eks_node_group" {
  source  = "assignment/eks-node-group/aws"
  version = "0.8.0"
